This project is a slide deck for an intro to node class built with impress.js. Which is an awesome presentation framework, much kudos to those guys for creating an awesome library.
